...
"선호하시는 여행 스타일을 입력하십시오.",
"입력하신 조건에 맞는 상품을 제안합니다.",
"다른 옵션이나 수정 사항을 말씀하십시오.",
"추가로 탐색할 내용을 결정하십시오.",
"여행 아이디어 탐색을 종료합니다."
],
"recommend_해요체": [
"추천 상담 시스템에 연결됐어요.",
"원하는 여행 아이디어를 탐색해 볼게요.",
"선호하는 여행 스타일을 입력해 주세요.",
"입력한 조건에 맞는 상품을 제안해요.",
"다른 옵션이나 수정 사항이 있으면 말씀해 주세요.",
"추가로 탐색할 내용을 결정해 주세요.",
"여행 아이디어 탐색을 종료할게요."
],
"recommend_반말체": [
...
# ==================================================
    ...
    # --------------------------------------------------
        ...
        if any(k in user_input for k in ["아니", "그만", "종료", "괜찮"]):
